...
namespace PIK_GP_Acad.Insolation.Services
{
    class CalcPointCentral
    {
        ...
        Point3d ptCalc;
        Point2d ptCalc2d;
        InsCalcServiceCentral insCalcService;        
        ...
        public CalcPointCentral (InsPoint insPt, Map map, InsCalcServiceCentral insCalcService)
        {
            ...
            this.insCalcService = insCalcService;            
        ...
        public List<IIlluminationArea> Calc ()
        {
            ...
            DefineAnglesStartEndByOwnerBuilding();
            ...
            resAreas = IllumAreaCentral.Invert(resAreas, angleStartOnPlane, angleEndOnPlane);

            return resAreas;
        }

        private object GetCalcExtents (object maxBuildingHeight)
        {
        ...
        private void DefineAnglesStartEndByOwnerBuilding ()
        {
