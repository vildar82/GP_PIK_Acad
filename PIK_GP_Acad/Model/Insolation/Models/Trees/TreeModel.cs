...
namespace PIK_GP_Acad.Insolation.Models
{
    ...
    {
        private IVisualInsPointSimple visualInsPointSimple;
        ...
        public TreeModel(InsModel insModel)
        {
            ...
            visualInsPointSimple = InsService.GetService<IVisualInsPointSimple>();
        }
        ...
        public void NewPoint ()
        {
            ...
            {                
                p.Calc();                            
                Points.Add(p);
                // Визуализация - одной точки (не елочки)
                visualInsPointSimple.Visual(p);
            }
        }        
